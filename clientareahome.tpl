...
<span class="dash">{$clientsdetails.companyname}</span> 
<span class="username">Logged in User: {$clientsdetails.email}</span>
<span class="adress">{$clientsdetails.city}, {$clientsdetails.country}</span>
</h5>
</div>
...
<a href="clientarea.php?action=services"><i class="glyphicon glyphicon-cloud"></i> <span class="title">{$LANG.navservices}</span> <span class="number">{$clientsstats.productsnumactive}</span></a>
</div>
{if $registerdomainenabled || $transferdomainenabled}
<div class="col-md-5ths col-xs-6">
<a href="clientarea.php?action=domains"><i class="glyphicon glyphicon-globe"></i> <span class="title">{$LANG.navdomains}</span> <span class="number">{$clientsstats.numactivedomains}</span></a>
</div>
{elseif $condlinks.affiliates && $clientsstats.isAffiliate}
<div class="col-md-5ths col-xs-6">
<a href="affiliates.php"><i class="glyphicon glyphicon-leaf"></i> <span class="title">{$LANG.affiliatessignups}</span> <span class="number">{$clientsstats.numaffiliatesignups}</span></a>
</div>
{/if}
<div class="col-md-5ths col-xs-6">
<a href="supporttickets.php"><i class="glyphicon glyphicon-cog"></i> <span class="title">{$LANG.navtickets}</span> <span class="number">{$clientsstats.numactivetickets}</span></a>
</div>
<div class="col-md-5ths col-xs-6">
<a href="clientarea.php?action=invoices"><i class="glyphicon glyphicon-usd"></i> <span class="title">{$LANG.navinvoices}</span> <span class="number">{$clientsstats.numunpaidinvoices}</span></a>
</div>
<div class="col-md-5ths col-xs-6">
<a href="clientarea.php?action=quotes"><i class="glyphicon glyphicon-check"></i> <span class="title">{$LANG.quotes}</span> <span class="number">{$clientsstats.numquotes}</span></a>
</div>
</div>
...
<div class="client-home-panels">
    <div class="row">
        ...
        <div class="col-sm-6 pdd-right-0">
            {foreach $panels as $item}
