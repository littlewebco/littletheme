...
<html lang="en" {if ($language == 'arabic' || $language == 'hebrew' || $language == 'farsi')}dir="rtl"{/if}>
    ...
    <body class="body-move body-style-1{if $loginpage eq 0 and $templatefile ne "clientregister"}not-login-page{/if}{if $templatefile == 'homepage'} this-is-index-page{/if}" data-phone-cc-input="{$phoneNumberInputStyle}">
    {$headeroutput}
    ...
    <header class="navbar coodiv-header navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse">
            <ul class="navbar-nav mr-auto">
               ...
               {include file="$template/template-parts/search.tpl"}  
