                        ...
                        <tr onclick="clickableSafeRedirect(event, 'clientarea.php?action=domaindetails&amp;id={$domain.id}', false)">
                            ...
                            <td>
                                <div class="btn-group btn-group-sm" style="width:60px;">
                                    <a href="clientarea.php?action=domaindetails&id={$domain.id}&modop=custom&a=manageDNSURLForwarding" class="btn btn-default"><i class="fas fa-wrench"></i></a>
                                    ...
                                    <ul class="dropdown-menu text-left dropdown-menu-right" role="menu">
                                        {if $domain.status eq 'Active'}
                                           ...
                                           <li><a href="clientarea.php?action=domaindetails&id={$domain.id}"><i class="glyphicon glyphicon-cloud"></i> Domain Details</a></li>
                                            <li class="divider"></li>
                                        {/if}
